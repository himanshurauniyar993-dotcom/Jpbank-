            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
              ...
              <form onSubmit={activeTab === 'create' ? handleCreateAccount : handleUpdateAccount} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Nickname (Max 18)</label>
                    <input
                      type="text"
                      required
                      maxLength={18}
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Username (Max 18)</label>
