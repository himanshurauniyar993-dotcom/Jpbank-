            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
              ...
              <form onSubmit={activeTab === 'create' ? handleCreateAccount : handleUpdateAccount} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Nickname (Max 16)</label>
                    <input
                      type="text"
                      required
                      maxLength={16}
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Username (Max 16)</label>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="relative group">
                      <div className="w-16 h-16 rounded-2xl bg-gray-100 border-2 border-dashed border-gray-300 flex items-center justify-center overflow-hidden">
